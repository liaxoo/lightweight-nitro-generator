...
<h4 align="center">A minimal, fast and easy to use Discord Nitro generator with a built-in checker.</h4>
...
You can [download](https://github.com/amitmerchant1990/electron-markdownify/releases/tag/v1.2.0) the latest stable release for Windows. Mac compatibility is in the works, and will be available in the next release.
